...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/jquery.fancybox.min.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/jquery.fancybox.min.js":
/*!*****************************************************!*\
  !*** ./app/javascript/packs/jquery.fancybox.min.js ***!
  \*****************************************************/
...
/* WEBPACK VAR INJECTION */(function(jQuery) {!function (e, t, i, n) {
  "use strict";
  ...
  i.extend(r, {
    ...
    _setDimension: function _setDimension() {
      ...
      if (S = g(s), W = g(o), d = s / o, H = g(u(H) ? g(H, "w") - n : H), D = g(u(D) ? g(D, "w") - n : D), L = g(u(L) ? g(L, "h") - a : L), A = g(u(A) ? g(A, "h") - a : A), l = D, c = A, T.fitToView && (D = Math.min(y.w - n, D), A = Math.min(y.h - a, A)), f = y.w - R, v = y.h - O, T.aspectRatio ? (S > D && (S = D, W = g(S / d)), W > A && (W = A, S = g(W * d)), H > S && (S = H, W = g(S / d)), L > W && (W = L, S = g(W * d))) : (S = Math.max(H, Math.min(S, D)), T.autoHeight && "iframe" !== T.type && (I.width(S), W = I.height()), W = Math.max(L, Math.min(W, A))), T.fitToView) if (I.width(S).height(W), j.width(S + e), h = j.width(), p = j.height(), T.aspectRatio) for (; (h > f || p > v) && S > H && W > L && !(x++ > 19);) {
    ...
    var t,
      ...
      var o,
          ...
          c = i(this).blur(),
          d = t;
      _s.ctrlKey || _s.altKey || _s.shiftKey || _s.metaKey || c.is(".fancybox-wrap") || (o = e.groupAttr || "data-fancybox-group", l = c.attr(o), l || (o = "rel", l = c.get(0)[o]), l && "" !== l && "nofollow" !== l && (c = a.length ? i(a) : n, c = c.filter("[" + o + '="' + l + '"]'), d = c.index(this)), e.index = d, r.open(c, e) !== !1 && _s.preventDefault());
    };
...
/******/ });
//# sourceMappingURL=jquery-00313621f887c7783ae6.js.map